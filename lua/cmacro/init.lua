...
function M.setup()
	vim.keymap.set("n", "gm", M.cmacro_comment_toggle_single_line)
	vim.keymap.set("v", "gm", M.cmacro_comment_toggle_visual_line)
	vim.keymap.set("n", "<leader>ml", M.cmacro_lineabreak_toggle_single_line)
	vim.keymap.set("v", "<leader>ml", M.cmacro_linebreak_toggle_visual_line)
end
